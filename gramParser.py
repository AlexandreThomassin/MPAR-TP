...
def serializedATN():
    return [
        ...
        1,2,1,2,5,2,32,8,2,10,2,12,2,35,9,2,1,2,1,2,1,3,1,3,1,3,1,3,5,3,
        43,8,3,10,3,12,3,46,9,3,1,3,1,3,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,
        ...
        0,0,0,6,38,1,0,0,0,8,49,1,0,0,0,10,64,1,0,0,0,12,73,1,0,0,0,14,75,
        1,0,0,0,16,94,1,0,0,0,18,19,3,2,1,0,19,20,3,4,2,0,20,21,3,10,5,0,
        21,22,5,0,0,1,22,1,1,0,0,0,23,26,3,6,3,0,24,26,3,8,4,0,25,23,1,0,
        0,0,25,24,1,0,0,0,26,3,1,0,0,0,27,28,5,2,0,0,28,33,5,12,0,0,29,30,
        ...
        0,0,38,39,5,1,0,0,39,44,5,12,0,0,40,41,5,7,0,0,41,43,5,12,0,0,42,
        40,1,0,0,0,43,46,1,0,0,0,44,42,1,0,0,0,44,45,1,0,0,0,45,47,1,0,0,
        0,46,44,1,0,0,0,47,48,5,6,0,0,48,7,1,0,0,0,49,50,5,1,0,0,50,51,5,
        12,0,0,51,52,5,4,0,0,52,59,5,11,0,0,53,54,5,7,0,0,54,55,5,12,0,0,
        55,56,5,4,0,0,56,58,5,11,0,0,57,53,1,0,0,0,58,61,1,0,0,0,59,57,1,
        ...
        0,0,0,108,109,5,6,0,0,109,17,1,0,0,0,8,25,33,44,59,68,73,89,105
    ]
...
class gramParser ( Parser ):
    ...
    ruleNames =  [ "program", "defstates", "defactions", "statenoreward", 
                   "statereward", "transitions", "trans", "transact", "transnoact" ]
    ...
    def statenoreward(self):
        ...
        self.enterRule(localctx, 6, self.RULE_statenoreward)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 38
    ...
    def statereward(self):
        ...
        self.enterRule(localctx, 8, self.RULE_statereward)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 49
